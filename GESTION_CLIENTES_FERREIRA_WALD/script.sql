...
DELIMITER $$
CREATE PROCEDURE SP_INS_CONTRATO(P_PRODUCTO INT, P_POLITICA INT, P_PROMOCION INT, P_CLIENTE INT, P_FCH_CONTRATO DATE, P_FCH_VIGENCIA DATE, P_STS BOOLEAN)
BEGIN
    DECLARE P_ESTADO INT;
...
SELECT  P.PRD_NOMBRE AS 'PRODUCTO', PL.POL_NOMBRE AS 'POLITICA'
FROM PRODUCTOPOL PP
INNER JOIN PRODUCTO P
	ON P.ID_PRODUCTO = PP.ID_PRODUCTO
INNER JOIN POLITICA PL
	ON PL.ID_POLITICA = PL.ID_POLITICA
WHERE P.IS_ACTIVO = 1
AND PL.IS_ACTIVO = 1
ORDER BY PP.ID_PRODUCTO, PP.ID_POLITICA;
...
INSERT INTO PRODUCTO (PRD_NOMBRE, IS_ACTIVO) VALUES
	('Internet FTTH 20MB', 1),
	('Internet FTTH 50MB', 1),
	('Internet FTTH 100MB', 1),
	('Internet FTTH 200MB', 1),
	('Internet FTTH 300MB', 1),
	('Internet HFC 20MB', 1),
	('Internet HFC 50MB', 1),
	('Internet HFC 100MB', 1),
	('Internet HFC 200MB', 1),
	('Internet HFC 300MB', 1),
	('Grilla Digital', 1),
	('Grilla Digital HD', 1),
	('Grilla Digital 4K', 1),
	('Decoder Adicional', 1),
	('Decoder Adicional HD', 1),
	('Decoder Adicional 4K', 1),
	('Pack Futbol', 1),
	('Basico', 1),
	('Basico Overlay', 1),
	('OTT', 1);
...
VALUES
    ...
    (17, 14, '2024-08-10', '2024-11-10'),
    (18, 14, '2024-08-10', '2024-11-10'),
    (19, 14, '2024-08-10', '2024-11-10'),
    (20, 14, '2024-08-10', '2024-11-10'),
    (21, 14, '2024-08-10', '2024-11-10'),
    (22, 14, '2024-08-10', '2024-11-10'),
    (23, 14, '2024-08-10', '2024-11-10'),
    (24, 14, '2024-08-10', '2024-11-10');
